...
<form method="GET" class="mb-4">
    <div class="row g-2 align-items-center">
        ...
        <div class="col-auto">
          <label for="weekFilter" class="col-form-label">Kalenderwoche:</label>
        </div>
        <div class="col-auto">
          <input type="week" name="week" id="weekFilter" class="form-control" value="{{ request('week') }}">
        </div>

        <div class="col-auto">
          <label for="dayFilter" class="col-form-label">Tag:</label>
        </div>
        <div class="col-auto">
        ...
        <div class="col-auto">
          <a href="{{ route('admin.projects.logs') }}" class="btn btn-secondary">Zurücksetzen</a>
        </div>
    </div>
</form>
