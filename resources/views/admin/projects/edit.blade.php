            ...
            <div class="card-body">
                <form action="{{ route('admin.projects.update', $project) }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="kunde" id="kunde" class="form-control" value="{{ old('kunde', $project->kunde) }}" placeholder="Enter customer name" required>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="project_name" id="project_name" class="form-control" value="{{ old('project_name', $project->project_name) }}" placeholder="Enter project name" required>
                    </div>
                    ...
                    <div class="mb-3">
                        <label for="start_time" class="form-label">Project Start Time</label>
                        <input type="datetime-local" name="start_time" id="start_time" class="form-control"
                               value="{{ old('start_time', isset($project) ? $project->start_time : '') }}">
                    </div>
                    
                    <div class="mb-3">
                        <label for="end_time" class="form-label">Project End Time</label>
